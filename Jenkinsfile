    ...
    stages {
        ...
        stage('beforeDeploy') {
            steps {
                ...
                /* groovylint-disable-next-line LineLength */
                sh 'docker build -t kareemelkasaby/challenge1-project:$SHA -t kareemelkasaby/challenge1-project:latest -f ./challenge1-project/Dockerfile.prod ./challenge1-project'
                /* groovylint-disable-next-line LineLength */
                sh 'docker build -t kareemelkasaby/challenge1-nginx:$SHA -t kareemelkasaby/challenge1-nginx:latest -f ./nginx/Dockerfile.prod ./nginx'
